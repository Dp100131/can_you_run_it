export function Footer() {
    ...
    return(
        <footer className="bg-primary rounded-lg shadow dark:bg-gray-900 m-4">
            <div className="flex w-full max-w-screen-xl mx-auto p-4 md:py-8 justify-around">
                ...
                <div className="flex flex-col gap-y-3">
                    <div>
                        <a href="https://flowbite.com/" className="flex items-center mb-4 sm:mb-0">
                            <span className="self-center text-2xl font-semibold whitespace-nowrap text-white dark:text-white">Profesor:</span>
                        </a>
                    </div> 
                    <div>
                        <ul className="flex flex-col mb-6 text-sm font-medium text-white  sm:mb-0 dark:text-gray-400"> 
